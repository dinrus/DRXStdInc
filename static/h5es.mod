...
integer(8),intent(in)::es_id
integer(8),intent(in)::timeout
integer(8),intent(out)::num_in_progress
logical(4),intent(out)::err_occurred
integer(4),intent(out)::hdferr
end
subroutine h5escancel_f(es_id,num_not_canceled,err_occurred,hdferr)
integer(8),intent(in)::es_id
integer(8),intent(out)::num_not_canceled
logical(4),intent(out)::err_occurred
integer(4),intent(out)::hdferr
end
