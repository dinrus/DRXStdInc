...
procedure::h5ltmake_dataset_f_ptr
end interface
interface h5ltread_dataset_f
procedure::h5ltread_dataset_f_ptr
end interface
interface
function h5ltmake_dataset_c(loc_id,namelen,dset_name,rank,dims,type_id,buf) bind(c, name="h5ltmake_dataset_c")
import::c_ptr
...
integer(4)::h5ltmake_dataset_c
end
end interface
interface
function h5ltread_dataset_c(loc_id,namelen,dset_name,type_id,buf) bind(c, name="h5ltread_dataset_c")
import::c_ptr
integer(8),intent(in)::loc_id
integer(8)::namelen
character(1_8,1),intent(in)::dset_name(1_8:*)
integer(8),intent(in)::type_id
type(c_ptr),value::buf
integer(4)::h5ltread_dataset_c
end
end interface
interface
function h5ltset_attribute_c(loc_id,namelen,dset_name,attrlen,attr_name,size,buf,dtype,sizeof_buf) bind(c, name="h5ltset_attribute_c")
import::c_ptr
integer(8),intent(in)::loc_id
integer(8)::namelen
character(1_8,1),intent(in)::dset_name(1_8:*)
integer(8)::attrlen
character(1_8,1),intent(in)::attr_name(1_8:*)
integer(8),intent(in)::size
type(c_ptr),value::buf
character(1_8,1),intent(in)::dtype(1_8:*)
integer(8)::sizeof_buf
integer(4)::h5ltset_attribute_c
end
end interface
interface
function h5ltget_attribute_c(loc_id,namelen,dset_name,attrlen,attr_name,buf,dtype,sizeof_buf) bind(c, name="h5ltget_attribute_c")
import::c_ptr
integer(8),intent(in)::loc_id
integer(8)::namelen
character(1_8,1),intent(in)::dset_name(1_8:*)
...
type(c_ptr),value::buf
character(1_8,1),intent(in)::dtype(1_8:*)
integer(8),intent(in)::sizeof_buf
integer(4)::h5ltget_attribute_c
end
end interface
contains
subroutine h5ltmake_dataset_f_ptr(loc_id,dset_name,rank,dims,type_id,buf,errcode)
integer(8),intent(in)::loc_id
...
subroutine h5ltmake_dataset_f_int1(loc_id,dset_name,rank,dims,type_id,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_f_int2(loc_id,dset_name,rank,dims,type_id,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_f_int3(loc_id,dset_name,rank,dims,type_id,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_f_int4(loc_id,dset_name,rank,dims,type_id,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_f_int5(loc_id,dset_name,rank,dims,type_id,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_f_int6(loc_id,dset_name,rank,dims,type_id,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_f_int7(loc_id,dset_name,rank,dims,type_id,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltread_dataset_f_ptr(loc_id,dset_name,type_id,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::type_id
type(c_ptr)::buf
...
subroutine h5ltread_dataset_f_int1(loc_id,dset_name,type_id,buf,dims,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::type_id
...
subroutine h5ltread_dataset_f_int2(loc_id,dset_name,type_id,buf,dims,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::type_id
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltread_dataset_f_int3(loc_id,dset_name,type_id,buf,dims,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::type_id
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltread_dataset_f_int4(loc_id,dset_name,type_id,buf,dims,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::type_id
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltread_dataset_f_int5(loc_id,dset_name,type_id,buf,dims,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::type_id
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltread_dataset_f_int6(loc_id,dset_name,type_id,buf,dims,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::type_id
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltread_dataset_f_int7(loc_id,dset_name,type_id,buf,dims,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::type_id
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_int_f_1(loc_id,dset_name,rank,dims,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_int_f_2(loc_id,dset_name,rank,dims,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_int_f_3(loc_id,dset_name,rank,dims,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_int_f_4(loc_id,dset_name,rank,dims,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_int_f_5(loc_id,dset_name,rank,dims,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_int_f_6(loc_id,dset_name,rank,dims,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltmake_dataset_int_f_7(loc_id,dset_name,rank,dims,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::rank
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltread_dataset_int_f_1(loc_id,dset_name,buf,dims,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::dims(1_8:*)
...
subroutine h5ltread_dataset_int_f_2(loc_id,dset_name,buf,dims,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::dims(1_8:*)
integer(4),intent(inout),target::buf(1_8:dims(1_8),1_8:dims(2_8))
...
subroutine h5ltread_dataset_int_f_3(loc_id,dset_name,buf,dims,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::dims(1_8:*)
integer(4),intent(inout),target::buf(1_8:dims(1_8),1_8:dims(2_8),1_8:dims(3_8))
...
type(c_ptr)::buf
character(*,1),intent(in)::buf_type
integer(8),intent(in)::sizeof_buf_type
integer(8),intent(in)::size
...
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(inout)::rank
integer(4)::errcode
end
function h5ltfind_dataset_f(loc_id,dset_name)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4)::h5ltfind_dataset_f
end
subroutine h5ltget_dataset_info_f(loc_id,dset_name,dims,type_class,type_size,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(inout)::dims(1_8:*)
integer(4),intent(inout)::type_class
...
logical(4),intent(in)::check_object_valid
logical(4),intent(out)::path_valid
integer(4),intent(out)::errcode
end
end
