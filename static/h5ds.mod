...
integer(8),intent(in)::dsid
integer(4)::errcode
character(*,1),intent(in),optional::dimname
end
...
integer(8),intent(in)::dsid
integer(4),intent(in)::idx
logical(4),intent(out)::is_attached
integer(4)::errcode
end
subroutine h5dsis_scale_f(did,is_scale,errcode)
integer(8),intent(in)::did
logical(4),intent(out)::is_scale
...
integer(8),intent(in)::did
integer(4),intent(in)::idx
character(*,1),intent(inout)::label
...
integer(8),intent(in)::did
integer(4),intent(in)::idx
integer(4),intent(inout)::num_scales
integer(4)::errcode
end
end
