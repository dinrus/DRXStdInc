...
integer(4)::type
integer(4)::rc
integer(4)::atime(1_8:8_8)
integer(4)::mtime(1_8:8_8)
integer(4)::ctime(1_8:8_8)
integer(4)::btime(1_8:8_8)
integer(8)::num_attrs
end type
...
interface
function h5oget_info_by_name_c(loc_id,name,lapl_id_default,object_info,fields,es_id,file,func,line) bind(c, name="h5oget_info_by_name_c")
import::c_ptr
integer(8)::loc_id
character(1_8,1)::name(1_8:*)
integer(8)::lapl_id_default
...
integer(4)::line
integer(4)::h5oget_info_by_name_c
end
end interface
contains
...
character(*,1),intent(in)::new_link_name
...
integer(4),intent(out)::hdferr
integer(8),intent(in),optional::ocpypl_id
integer(8),intent(in),optional::lcpl_id
end
...
character(*,1),intent(out)::comment
integer(4),intent(out)::hdferr
integer(8),intent(out),optional::bufsize
end
...
integer(4),intent(out)::hdferr
integer(4),intent(in),optional::fields
end
...
integer(8),intent(in)::loc_id
character(*,1),intent(in)::object_name
integer(4),intent(in)::index_type
integer(4),intent(in)::order
type(c_funptr),intent(in)::op
type(c_ptr),intent(inout)::op_data
...
integer(4),intent(out)::cmp_value
integer(4),intent(out)::hdferr
end
end
