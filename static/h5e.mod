...
integer(4),parameter::printon=1_4
integer(4),parameter::printoff=0_4
contains
subroutine h5eclear_f(hdferr,estack_id)
integer(4),intent(out)::hdferr
integer(8),intent(in),optional::estack_id
end
