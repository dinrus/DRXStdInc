...
integer(1)::ref(1_8:12_8)
end type
interface h5rget_object_type_f
procedure::h5rget_object_type_obj_f
end interface
interface h5rget_region_f
procedure::h5rget_region_ptr_f
procedure::h5rget_region_region_f
end interface
interface h5rcreate_f
procedure::h5rcreate_ptr_f
procedure::h5rcreate_object_f
procedure::h5rcreate_region_f
end interface
interface h5rdereference_f
procedure::h5rdereference_ptr_f
procedure::h5rdereference_object_f
procedure::h5rdereference_region_f
end interface
interface h5rget_name_f
procedure::h5rget_name_ptr_f
procedure::h5rget_name_object_f
procedure::h5rget_name_region_f
end interface
interface
function h5rget_name_ptr_c(loc_id,ref_type,ref,name,name_len,size_default) bind(c, name="h5rget_name_ptr_c")
import::c_ptr
integer(8),intent(in)::loc_id
integer(4),intent(in)::ref_type
type(c_ptr),intent(in),value::ref
character(1_8,1),intent(in)::name(1_8:*)
integer(8)::name_len
integer(8)::size_default
integer(4)::h5rget_name_ptr_c
end
end interface
interface
function h5rdereference_ptr_c(obj_id,ref_type,ref,ref_obj_id) bind(c, name="h5rdereference_ptr_c")
import::c_ptr
integer(8),intent(in)::obj_id
integer(4),intent(in)::ref_type
type(c_ptr),intent(in),value::ref
integer(8),intent(out)::ref_obj_id
integer(4)::h5rdereference_ptr_c
end
end interface
interface
function h5rcreate_ptr_c(ref,loc_id,name,namelen,ref_type,space_id) bind(c, name="h5rcreate_ptr_c")
import::c_ptr
...
integer(4)::h5rcreate_ptr_c
end
end interface
interface
function h5rget_region_ptr_c(dset_id,ref,space_id) bind(c, name="h5rget_region_ptr_c")
import::c_ptr
integer(8),intent(in)::dset_id
type(c_ptr),value::ref
integer(8),intent(out)::space_id
integer(4)::h5rget_region_ptr_c
end
end interface
private::h5rget_object_type_obj_f
private::h5rget_region_region_f
private::h5rget_region_ptr_f
private::h5rcreate_object_f
private::h5rcreate_region_f
private::h5rcreate_ptr_f
private::h5rdereference_object_f
private::h5rdereference_region_f
private::h5rdereference_ptr_f
private::h5rget_name_object_f
private::h5rget_name_region_f
private::h5rget_name_ptr_f
contains
...
integer(4),intent(out)::hdferr
integer(8),intent(in),optional::space_id
end
