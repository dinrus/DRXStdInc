...
private::c_funloc
private::h5_fortran_num_integer_kinds
private::haddr_t
private::hsize_t
private::hssize_t
private::off_t
private::size_t
private::time_t
private::fortran_integer
private::fortran_integer_avail_kinds
private::fortran_real_c_double
private::fortran_real_c_long_double
private::fortran_real_c_float
private::fortran_real_c_float128
private::hid_t
private::fortran_real
private::fortran_double
private::h5r_dset_reg_ref_buf_size_f
private::h5o_max_token_size_f
private::object_namelen_default_f
private::h5_real_kind
private::h5_integer_kind
private::ref_reg_buf_len
private::h5o_token_buf_len
private::hobj_ref_t_f
private::hdset_reg_ref_t_f
private::predef_types_len
private::floating_types_len
private::integer_types_len
private::predef_types
private::floating_types
private::integer_types
private::h5t_native_real_c_float
private::h5t_native_real_c_double
private::h5t_native_real_c_long_double
private::h5t_native_integer
private::h5t_native_real
private::h5t_native_double
private::h5t_native_character
private::h5t_std_ref_obj
private::h5t_std_ref_dsetreg
private::h5t_ieee_f32be
private::h5t_ieee_f32le
private::h5t_ieee_f64be
private::h5t_ieee_f64le
private::h5t_std_i8be
private::h5t_std_i8le
private::h5t_std_i16be
private::h5t_std_i16le
private::h5t_std_i32be
private::h5t_std_i32le
private::h5t_std_i64be
private::h5t_std_i64le
private::h5t_std_u8be
private::h5t_std_u8le
private::h5t_std_u16be
private::h5t_std_u16le
private::h5t_std_u32be
private::h5t_std_u32le
private::h5t_std_u64be
private::h5t_std_u64le
private::h5t_string
private::h5t_std_b8be
private::h5t_std_b8le
private::h5t_std_b16be
private::h5t_std_b16le
private::h5t_std_b32be
private::h5t_std_b32le
private::h5t_std_b64be
private::h5t_std_b64le
private::h5t_native_b8
private::h5t_native_b16
private::h5t_native_b32
private::h5t_native_b64
private::h5t_fortran_s1
private::h5t_c_s1
private::num_native_integer_kind
private::h5t_native_integer_kind
private::h5t_native_float_128
private::h5_index_unknown_f
private::h5_index_name_f
private::h5_index_crt_order_f
private::h5_index_n_f
private::h5_iter_unknown_f
private::h5_iter_inc_f
private::h5_iter_dec_f
private::h5_iter_native_f
private::h5_iter_n_f
private::haddr_undef_f
private::h5f_acc_rdwr_f
private::h5f_acc_rdonly_f
private::h5f_acc_trunc_f
private::h5f_acc_excl_f
private::h5f_acc_debug_f
private::h5f_scope_local_f
private::h5f_scope_global_f
private::h5f_close_default_f
private::h5f_close_weak_f
private::h5f_close_semi_f
private::h5f_close_strong_f
private::h5f_obj_file_f
private::h5f_obj_dataset_f
private::h5f_obj_group_f
private::h5f_obj_datatype_f
private::h5f_obj_all_f
private::h5f_libver_earliest_f
private::h5f_libver_latest_f
private::h5f_unlimited_f
private::h5f_libver_error_f
private::h5f_libver_nbounds_f
private::h5f_libver_v18_f
private::h5f_libver_v110_f
private::h5f_libver_v112_f
private::h5f_libver_v114_f
private::h5g_unknown_f
private::h5g_group_f
private::h5g_dataset_f
private::h5g_type_f
private::h5g_link_f
private::h5g_udlink_f
private::h5g_same_loc_f
private::h5g_link_error_f
private::h5g_link_hard_f
private::h5g_link_soft_f
private::h5g_storage_type_unknown_f
private::h5g_storage_type_symbol_table_f
private::h5g_storage_type_compact_f
private::h5g_storage_type_dense_f
private::h5d_compact_f
private::h5d_contiguous_f
private::h5d_chunked_f
private::h5d_alloc_time_error_f
private::h5d_alloc_time_default_f
private::h5d_alloc_time_early_f
private::h5d_alloc_time_late_f
private::h5d_alloc_time_incr_f
private::h5d_space_sts_error_f
private::h5d_space_sts_not_allocated_f
private::h5d_space_sts_part_allocated_f
private::h5d_space_sts_allocated_f
private::h5d_fill_time_error_f
private::h5d_fill_time_alloc_f
private::h5d_fill_time_never_f
private::h5d_fill_value_error_f
private::h5d_fill_value_undefined_f
private::h5d_fill_value_default_f
private::h5d_fill_value_user_defined_f
private::h5d_chunk_cache_nslots_dflt_f
private::h5d_chunk_cache_nbytes_dflt_f
private::h5d_chunk_cache_w0_dflt_f
private::h5d_mpio_no_collective_f
private::h5d_mpio_chunk_independent_f
private::h5d_mpio_chunk_collective_f
private::h5d_mpio_chunk_mixed_f
private::h5d_mpio_contig_collective_f
private::h5d_vds_error_f
private::h5d_vds_first_missing_f
private::h5d_vds_last_available_f
private::h5d_virtual_f
private::h5d_selection_io_mode_default_f
private::h5d_selection_io_mode_off_f
private::h5d_selection_io_mode_on_f
private::h5e_default_f
private::h5e_major_f
private::h5e_minor_f
private::h5e_walk_upward_f
private::h5e_walk_downward_f
private::h5es_none_f
private::h5es_status_in_progress_f
private::h5es_status_succeed_f
private::h5es_status_canceled_f
private::h5es_status_fail_f
private::h5es_wait_forever_f
private::h5es_wait_none_f
private::h5fd_mpio_independent_f
private::h5fd_mpio_collective_f
private::h5fd_mem_nolist_f
private::h5fd_mem_default_f
private::h5fd_mem_super_f
private::h5fd_mem_btree_f
private::h5fd_mem_draw_f
private::h5fd_mem_gheap_f
private::h5fd_mem_lheap_f
private::h5fd_mem_ohdr_f
private::h5fd_mem_ntypes_f
private::h5fd_subfiling_curr_fapl_version_f
private::h5fd_subfiling_fapl_magic_f
private::h5fd_subfiling_default_stripe_count_f
private::h5fd_ioc_curr_fapl_version_f
private::h5fd_ioc_fapl_magic_f
private::h5fd_ioc_default_thread_pool_size_f
private::select_ioc_one_per_node_f
private::select_ioc_every_nth_rank_f
private::select_ioc_with_config_f
private::select_ioc_total_f
private::ioc_selection_options_f
private::h5fd_core_f
private::h5fd_family_f
private::h5fd_log_f
private::h5fd_mpio_f
private::h5fd_multi_f
private::h5fd_sec2_f
private::h5fd_stdio_f
private::h5fd_subfiling_f
private::h5fd_subfiling_default_stripe_size_f
private::h5i_file_f
private::h5i_group_f
private::h5i_datatype_f
private::h5i_dataspace_f
private::h5i_dataset_f
private::h5i_attr_f
private::h5i_badid_f
private::h5i_uninit_f
private::h5i_vfl_f
private::h5i_vol_f
private::h5i_genprop_cls_f
private::h5i_genprop_lst_f
private::h5i_error_class_f
private::h5i_error_msg_f
private::h5i_error_stack_f
private::h5i_ntypes_f
private::h5i_invalid_hid_f
private::h5l_type_error_f
private::h5l_type_hard_f
private::h5l_type_soft_f
private::h5l_type_external_f
private::h5l_same_loc_f
private::h5l_link_class_t_vers_f
private::h5o_token_t_f
private::h5o_copy_shallow_hierarchy_f
private::h5o_copy_expand_soft_link_f
private::h5o_copy_expand_ext_link_f
private::h5o_copy_expand_reference_f
private::h5o_copy_without_attr_flag_f
private::h5o_copy_preserve_null_flag_f
private::h5o_copy_all_f
private::h5o_shmesg_none_flag_f
private::h5o_shmesg_sdspace_flag_f
private::h5o_shmesg_dtype_flag_f
private::h5o_shmesg_fill_flag_f
private::h5o_shmesg_pline_flag_f
private::h5o_shmesg_attr_flag_f
private::h5o_shmesg_all_flag_f
private::h5o_hdr_chunk0_size_f
private::h5o_hdr_attr_crt_order_track_f
private::h5o_hdr_attr_crt_order_index_f
private::h5o_hdr_attr_store_phase_cha_f
private::h5o_hdr_store_times_f
private::h5o_hdr_all_flags_f
private::h5o_shmesg_max_nindexes_f
private::h5o_shmesg_max_list_size_f
private::h5o_type_unknown_f
private::h5o_type_group_f
private::h5o_type_dataset_f
private::h5o_type_named_datatype_f
private::h5o_type_ntypes_f
private::h5o_info_all_f
private::h5o_info_basic_f
private::h5o_info_time_f
private::h5o_info_num_attrs_f
private::h5o_info_hdr_f
private::h5o_info_meta_size_f
private::h5p_file_create_f
private::h5p_file_access_f
private::h5p_dataset_create_f
private::h5p_dataset_xfer_f
private::h5p_file_mount_f
private::h5p_default_f
private::h5p_root_f
private::h5p_object_create_f
private::h5p_dataset_access_f
private::h5p_group_create_f
private::h5p_group_access_f
private::h5p_datatype_create_f
private::h5p_datatype_access_f
private::h5p_string_create_f
private::h5p_attribute_create_f
private::h5p_object_copy_f
private::h5p_link_create_f
private::h5p_link_access_f
private::h5p_crt_order_indexed_f
private::h5p_crt_order_tracked_f
private::h5r_object_f
private::h5r_dataset_region_f
private::h5s_unlimited_f
private::h5s_all_f
private::h5s_scalar_f
private::h5s_simple_f
private::h5s_null_f
private::h5s_select_noop_f
private::h5s_select_set_f
private::h5s_select_or_f
private::h5s_select_and_f
private::h5s_select_xor_f
private::h5s_select_notb_f
private::h5s_select_nota_f
private::h5s_select_append_f
private::h5s_select_prepend_f
private::h5s_select_invalid_f
private::h5s_sel_error_f
private::h5s_sel_none_f
private::h5s_sel_points_f
private::h5s_sel_hyperslabs_f
private::h5s_sel_all_f
private::h5t_no_class_f
private::h5t_integer_f
private::h5t_float_f
private::h5t_time_f
private::h5t_string_f
private::h5t_bitfield_f
private::h5t_opaque_f
private::h5t_compound_f
private::h5t_reference_f
private::h5t_enum_f
private::h5t_vlen_f
private::h5t_array_f
private::h5t_order_le_f
private::h5t_order_be_f
private::h5t_order_vax_f
private::h5t_order_none_f
private::h5t_order_mixed_f
private::h5t_pad_zero_f
private::h5t_pad_one_f
private::h5t_pad_background_f
private::h5t_pad_error_f
private::h5t_sgn_none_f
private::h5t_sgn_2_f
private::h5t_sgn_error_f
private::h5t_norm_implied_f
private::h5t_norm_msbset_f
private::h5t_norm_none_f
private::h5t_cset_ascii_f
private::h5t_cset_utf8_f
private::h5t_str_nullterm_f
private::h5t_str_nullpad_f
private::h5t_str_spacepad_f
private::h5t_str_error_f
private::h5t_dir_ascend_f
private::h5t_dir_descend_f
private::h5vl_version_f
private::h5_vol_invalid_f
private::h5_vol_native_f
private::h5vl_cap_flag_none_f
private::h5vl_cap_flag_threadsafe_f
private::h5vl_cap_flag_async_f
private::h5vl_cap_flag_native_files_f
private::h5vl_cap_flag_attr_basic_f
private::h5vl_cap_flag_attr_more_f
private::h5vl_cap_flag_dataset_basic_f
private::h5vl_cap_flag_dataset_more_f
private::h5vl_cap_flag_file_basic_f
private::h5vl_cap_flag_file_more_f
private::h5vl_cap_flag_group_basic_f
private::h5vl_cap_flag_group_more_f
private::h5vl_cap_flag_link_basic_f
private::h5vl_cap_flag_link_more_f
private::h5vl_cap_flag_map_basic_f
private::h5vl_cap_flag_map_more_f
private::h5vl_cap_flag_object_basic_f
private::h5vl_cap_flag_object_more_f
private::h5vl_cap_flag_ref_basic_f
private::h5vl_cap_flag_ref_more_f
private::h5vl_cap_flag_obj_ref_f
private::h5vl_cap_flag_reg_ref_f
private::h5vl_cap_flag_attr_ref_f
private::h5vl_cap_flag_stored_datatypes_f
private::h5vl_cap_flag_creation_order_f
private::h5vl_cap_flag_iterate_f
private::h5vl_cap_flag_storage_size_f
private::h5vl_cap_flag_by_idx_f
private::h5vl_cap_flag_get_plist_f
private::h5vl_cap_flag_flush_refresh_f
private::h5vl_cap_flag_external_links_f
private::h5vl_cap_flag_hard_links_f
private::h5vl_cap_flag_soft_links_f
private::h5vl_cap_flag_ud_links_f
private::h5vl_cap_flag_track_times_f
private::h5vl_cap_flag_mount_f
private::h5vl_cap_flag_filters_f
private::h5vl_cap_flag_fill_values_f
private::h5vl_opt_query_supported_f
private::h5vl_opt_query_read_data_f
private::h5vl_opt_query_write_data_f
private::h5vl_opt_query_query_metadata_f
private::h5vl_opt_query_modify_metadata_f
private::h5vl_opt_query_collective_f
private::h5vl_opt_query_no_async_f
private::h5vl_opt_query_multi_obj_f
private::h5z_filter_error_f
private::h5z_filter_none_f
private::h5z_filter_all_f
private::h5z_filter_deflate_f
private::h5z_filter_shuffle_f
private::h5z_filter_fletcher32_f
private::h5z_filter_szip_f
private::h5z_error_edc_f
private::h5z_disable_edc_f
private::h5z_enable_edc_f
private::h5z_no_edc_f
private::h5z_flag_optional_f
private::h5z_filter_encode_enabled_f
private::h5z_filter_decode_enabled_f
private::h5z_filter_nbit_f
private::h5z_filter_scaleoffset_f
private::h5z_so_float_dscale_f
private::h5z_so_float_escale_f
private::h5z_so_int_f
private::h5z_so_int_minbits_default_f
private::h5_szip_ec_om_f
private::h5_szip_nn_om_f
integer(4),parameter,private::h5f_flags_len=25_4
integer(4),private::h5f_flags(1_8:25_8)
integer(4),parameter,private::h5generic_flags_len=9_4
integer(4),private::h5generic_flags(1_8:9_8)
integer(4),parameter,private::h5generic_haddr_flags_len=1_4
integer(8),private::h5generic_haddr_flags(1_8:1_8)
integer(4),parameter,private::h5g_flags_len=12_4
integer(4),private::h5g_flags(1_8:12_8)
integer(4),parameter,private::h5d_flags_len=32_4
integer(4),private::h5d_flags(1_8:32_8)
integer(4),parameter,private::h5d_size_flags_len=2_4
integer(8),private::h5d_size_flags(1_8:2_8)
integer(4),parameter,private::h5e_flags_len=4_4
integer(4),private::h5e_flags(1_8:4_8)
integer(4),parameter,private::h5e_hid_flags_len=1_4
integer(8),private::h5e_hid_flags(1_8:1_8)
integer(4),parameter,private::h5es_flags_len=4_4
integer(4),private::h5es_flags(1_8:4_8)
integer(4),parameter,private::h5es_hid_flags_len=1_4
integer(8),private::h5es_hid_flags(1_8:1_8)
integer(4),parameter,private::h5fd_flags_len=22_4
integer(4),private::h5fd_flags(1_8:22_8)
integer(4),parameter,private::h5fd_hid_flags_len=9_4
integer(8),private::h5fd_hid_flags(1_8:9_8)
integer(4),parameter,private::h5i_flags_len=17_4
integer(4),private::h5i_flags(1_8:17_8)
integer(4),parameter,private::h5l_flags_len=6_4
integer(4),private::h5l_flags(1_8:6_8)
integer(4),parameter,private::h5o_flags_len=33_4
integer(4),private::h5o_flags(1_8:33_8)
integer(4),parameter,private::h5p_flags_len=18_4
integer(8),private::h5p_flags(1_8:18_8)
integer(4),parameter,private::h5p_flags_int_len=2_4
integer(4),private::h5p_flags_int(1_8:2_8)
integer(4),parameter,private::h5r_flags_len=2_4
integer(4),private::h5r_flags(1_8:2_8)
integer(4),parameter,private::h5s_flags_len=18_4
integer(4),private::h5s_flags(1_8:18_8)
integer(4),parameter,private::h5s_hsize_flags_len=1_4
integer(8),private::h5s_hsize_flags(1_8:1_8)
integer(4),parameter,private::h5s_hid_flags_len=1_4
integer(8),private::h5s_hid_flags(1_8:1_8)
integer(4),parameter,private::h5t_flags_len=35_4
integer(4),private::h5t_flags(1_8:35_8)
integer(4),parameter,private::h5vl_flags_len=3_4
integer(4),private::h5vl_flags(1_8:3_8)
integer(4),parameter,private::h5vl_int64_flags_len=46_4
integer(8),private::h5vl_int64_flags(1_8:46_8)
integer(4),parameter,private::h5z_flags_len=20_4
integer(4),private::h5z_flags(1_8:20_8)
integer(4),parameter,private::h5lib_flags_len=2_4
integer(4),private::h5lib_flags(1_8:2_8)
contains
...
integer(4),intent(out)::majnum
integer(4),intent(out)::minnum
integer(4),intent(out)::relnum
integer(4),intent(out)::error
end
subroutine h5check_version_f(majnum,minnum,relnum,error)
integer(4),intent(in)::majnum
integer(4),intent(in)::minnum
integer(4),intent(in)::relnum
integer(4),intent(out)::error
end
...
function h5kind_to_type(ikind,flag) result(h5_type)
integer(4),intent(in)::ikind
...
integer(8),intent(in)::stdtime_t
integer(4)::datetime(1_8:8_8)
end
end
