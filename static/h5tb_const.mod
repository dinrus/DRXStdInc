...
procedure::h5tbwrite_field_name_f_int
procedure::h5tbwrite_field_name_f_string
end interface
interface h5tbread_field_name_f
procedure::h5tbread_field_name_f_int
procedure::h5tbread_field_name_f_string
end interface
interface h5tbwrite_field_index_f
procedure::h5tbwrite_field_index_f_int
procedure::h5tbwrite_field_index_f_string
end interface
interface h5tbread_field_index_f
procedure::h5tbread_field_index_f_int
procedure::h5tbread_field_index_f_string
end interface
interface h5tbinsert_field_f
procedure::h5tbinsert_field_f_int
procedure::h5tbinsert_field_f_string
end interface
interface h5tbmake_table_f
procedure::h5tbmake_table_f90
procedure::h5tbmake_table_ptr_f
end interface
interface
function h5tbwrite_field_name_c(loc_id,namelen,dset_name,namelen1,field_name,start,nrecords,type_size,buf) bind(c, name="h5tbwrite_field_name_c")
import::c_ptr
integer(8),intent(in)::loc_id
integer(8)::namelen
character(1_8,1),intent(in)::dset_name(1_8:*)
integer(8)::namelen1
character(1_8,1),intent(in)::field_name(1_8:*)
integer(8),intent(in)::start
integer(8),intent(in)::nrecords
integer(8),intent(in)::type_size
type(c_ptr),value::buf
integer(4)::h5tbwrite_field_name_c
end
end interface
interface
function h5tbread_field_name_c(loc_id,namelen,dset_name,namelen1,field_name,start,nrecords,type_size,buf) bind(c, name="h5tbread_field_name_c")
import::c_ptr
integer(8),intent(in)::loc_id
integer(8)::namelen
character(1_8,1),intent(in)::dset_name(1_8:*)
...
integer(8),intent(in)::type_size
type(c_ptr),value::buf
integer(4)::h5tbread_field_name_c
end
end interface
interface
function h5tbwrite_field_index_c(loc_id,namelen,dset_name,field_index,start,nrecords,type_size,buf) bind(c, name="h5tbwrite_field_index_c")
import::c_ptr
integer(8),intent(in)::loc_id
integer(8)::namelen
character(1_8,1),intent(in)::dset_name(1_8:*)
...
integer(8),intent(in)::type_size
type(c_ptr),value::buf
integer(4)::h5tbwrite_field_index_c
end
end interface
interface
function h5tbread_field_index_c(loc_id,namelen,dset_name,field_index,start,nrecords,type_size,buf) bind(c, name="h5tbread_field_index_c")
import::c_ptr
integer(8),intent(in)::loc_id
integer(8)::namelen
character(1_8,1),intent(in)::dset_name(1_8:*)
...
integer(8),intent(in)::type_size
type(c_ptr),value::buf
integer(4)::h5tbread_field_index_c
end
end interface
interface
function h5tbinsert_field_c(loc_id,namelen,dset_name,namelen1,field_name,field_type,field_index,buf) bind(c, name="h5tbinsert_field_c")
import::c_ptr
integer(8),intent(in)::loc_id
integer(8)::namelen
character(1_8,1),intent(in)::dset_name(1_8:*)
...
integer(4),intent(in)::field_index
type(c_ptr),value::buf
integer(4)::h5tbinsert_field_c
end
end interface
contains
subroutine h5tbmake_table_f90(table_title,loc_id,dset_name,nfields,nrecords,type_size,field_names,field_offset,field_types,chunk_size,compress,errcode)
character(*,1),intent(in)::table_title
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(in)::nfields
integer(8),intent(in)::nrecords
integer(8),intent(in)::type_size
character(*,1),intent(in)::field_names(1_8:nfields)
integer(8),intent(in)::field_offset(1_8:nfields)
integer(8),intent(in)::field_types(1_8:nfields)
integer(8),intent(in)::chunk_size
integer(4),intent(in)::compress
integer(4)::errcode
end
subroutine h5tbmake_table_ptr_f(table_title,loc_id,dset_name,nfields,nrecords,type_size,field_names,field_offset,field_types,chunk_size,fill_data,compress,data,errcode)
use,intrinsic::iso_c_binding,only:c_ptr
character(*,1),intent(in)::table_title
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
...
character(*,1),intent(in)::dset_name
integer(8),intent(in)::nfields
integer(8),intent(in)::dst_size
integer(8),intent(in)::dst_offset(1_8:nfields)
integer(8),intent(in)::dst_sizes(1_8:nfields)
type(c_ptr)::dst_buf
integer(4)::errcode
end
subroutine h5tbwrite_field_name_f_int(loc_id,dset_name,field_name,start,nrecords,type_size,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
...
integer(8),intent(in)::nrecords
integer(8),intent(in)::type_size
integer(4),intent(in),target::buf(1_8:*)
integer(4)::errcode
end
subroutine h5tbwrite_field_name_f_string(loc_id,dset_name,field_name,start,nrecords,type_size,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
character(*,1),intent(in)::field_name
integer(8),intent(in)::start
integer(8),intent(in)::nrecords
integer(8),intent(in)::type_size
character(*,1),intent(in),target::buf(1_8:*)
integer(4)::errcode
end
subroutine h5tbread_field_name_f_int(loc_id,dset_name,field_name,start,nrecords,type_size,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
character(*,1),intent(in)::field_name
integer(8),intent(in)::start
integer(8),intent(in)::nrecords
integer(8),intent(in)::type_size
integer(4),intent(inout),target::buf(1_8:*)
integer(4)::errcode
end
subroutine h5tbread_field_name_f_string(loc_id,dset_name,field_name,start,nrecords,type_size,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
character(*,1),intent(in)::field_name
integer(8),intent(in)::start
integer(8),intent(in)::nrecords
integer(8),intent(in)::type_size
character(*,1),intent(inout),target::buf(1_8:*)
integer(4)::errcode
end
subroutine h5tbwrite_field_index_f_int(loc_id,dset_name,field_index,start,nrecords,type_size,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::field_index
integer(8),intent(in)::start
...
subroutine h5tbwrite_field_index_f_string(loc_id,dset_name,field_index,start,nrecords,type_size,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::field_index
integer(8),intent(in)::start
...
subroutine h5tbread_field_index_f_int(loc_id,dset_name,field_index,start,nrecords,type_size,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::field_index
integer(8),intent(in)::start
...
subroutine h5tbread_field_index_f_string(loc_id,dset_name,field_index,start,nrecords,type_size,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(4),intent(in)::field_index
integer(8),intent(in)::start
...
subroutine h5tbinsert_field_f_int(loc_id,dset_name,field_name,field_type,position,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
character(*,1),intent(in)::field_name
integer(8),intent(in)::field_type
...
subroutine h5tbinsert_field_f_string(loc_id,dset_name,field_name,field_type,position,buf,errcode)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
character(*,1),intent(in)::field_name
integer(8),intent(in)::field_type
...
integer(8),intent(in)::loc_id
character(*,1),intent(in)::dset_name
integer(8),intent(inout)::nfields
integer(8),intent(inout)::nrecords
integer(4)::errcode
end
...
character(*,1),intent(in)::dset_name
integer(8),intent(in)::nfields
character(*,1),intent(inout)::field_names(1_8:nfields)
integer(8),intent(inout)::field_sizes(1_8:nfields)
integer(8),intent(inout)::field_offsets(1_8:nfields)
integer(8),intent(inout)::type_size
integer(4)::errcode
integer(8),optional::maxlen_out
end
end
