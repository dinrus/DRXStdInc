...
integer(8)::h5open_num_obj
interface
function h5fis_accessible(name,access_prp_default) bind(c, name="H5Fis_accessible")
character(1_8,1),intent(in)::name(1_8:*)
integer(8),intent(in),value::access_prp_default
integer(4)::h5fis_accessible
end
end interface
contains
subroutine h5fcreate_f(name,access_flags,file_id,hdferr,creation_prp,access_prp)
character(*,1),intent(in)::name
integer(4),intent(in)::access_flags
integer(8),intent(out)::file_id
integer(4),intent(out)::hdferr
integer(8),intent(in),optional::creation_prp
integer(8),intent(in),optional::access_prp
end
...
integer(8),intent(out)::ret_file_id
integer(4),intent(out)::hdferr
end
...
integer(8),intent(in)::file_id
integer(8),intent(out)::prop_id
integer(4),intent(out)::hdferr
end
subroutine h5fget_access_plist_f(file_id,access_id,hdferr)
integer(8),intent(in)::file_id
integer(8),intent(out)::access_id
integer(4),intent(out)::hdferr
end
...
integer(8),intent(in)::file_id
integer(4),intent(in)::obj_type
integer(8),intent(out)::obj_count
integer(4),intent(out)::hdferr
end
subroutine h5fget_obj_ids_f(file_id,obj_type,max_objs,obj_ids,hdferr,num_objs)
integer(8),intent(in)::file_id
integer(4),intent(in)::obj_type
integer(8),intent(in)::max_objs
integer(8),intent(inout)::obj_ids(1_8:*)
integer(4),intent(out)::hdferr
integer(8),intent(out),optional::num_objs
end
subroutine h5fget_freespace_f(file_id,free_space,hdferr)
integer(8),intent(in)::file_id
integer(8),intent(out)::free_space
integer(4),intent(out)::hdferr
end
...
integer(4),intent(out)::hdferr
integer(8),intent(out),optional::buf_size
end
