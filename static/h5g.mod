...
integer(4)::storage_type
integer(8)::nlinks
integer(8)::max_corder
logical(1)::mounted
end type
interface h5gget_info_f
procedure::h5gget_info_f90
procedure::h5gget_info_f03
end interface
interface h5gget_info_by_idx_f
procedure::h5gget_info_by_idx_f90
procedure::h5gget_info_by_idx_f03
end interface
interface h5gget_info_by_name_f
procedure::h5gget_info_by_name_f90
procedure::h5gget_info_by_name_f03
end interface
interface
function h5gget_info(loc_id,ginfo) bind(c, name="H5Gget_info")
import::c_ptr
integer(8),value::loc_id
type(c_ptr),value::ginfo
integer(4)::h5gget_info
end
end interface
interface
function h5gget_info_async(file,func,line,loc_id,ginfo,es_id) bind(c, name="H5Gget_info_async")
import::c_ptr
type(c_ptr),value::file
type(c_ptr),value::func
integer(4),value::line
integer(8),value::loc_id
type(c_ptr),value::ginfo
integer(8),value::es_id
integer(4)::h5gget_info_async
end
end interface
interface
function h5gget_info_by_idx(loc_id,group_name,idx_type,order,n,ginfo,lapl_id) bind(c, name="H5Gget_info_by_idx")
import::c_ptr
integer(8),value::loc_id
character(1_8,1)::group_name(1_8:*)
integer(4),value::idx_type
integer(4),value::order
integer(8),value::n
type(c_ptr),value::ginfo
integer(8),value::lapl_id
integer(4)::h5gget_info_by_idx
end
end interface
interface
function h5gget_info_by_idx_async(file,func,line,loc_id,group_name,idx_type,order,n,ginfo,lapl_id,es_id) bind(c, name="H5Gget_info_by_idx_async")
import::c_ptr
type(c_ptr),value::file
type(c_ptr),value::func
integer(4),value::line
...
integer(8),value::lapl_id
integer(8),value::es_id
integer(4)::h5gget_info_by_idx_async
end
end interface
interface
function h5gget_info_by_name(loc_id,name,ginfo,lapl_id) bind(c, name="H5Gget_info_by_name")
import::c_ptr
integer(8),value::loc_id
character(1_8,1)::name(1_8:*)
type(c_ptr),value::ginfo
integer(8),value::lapl_id
integer(4)::h5gget_info_by_name
end
end interface
interface
function h5gget_info_by_name_async(file,func,line,loc_id,name,ginfo,lapl_id,es_id) bind(c, name="H5Gget_info_by_name_async")
import::c_ptr
type(c_ptr),value::file
type(c_ptr),value::func
integer(4),value::line
...
integer(8),value::lapl_id
integer(8),value::es_id
integer(4)::h5gget_info_by_name_async
end
end interface
contains
...
integer(8),intent(out)::grp_id
integer(4),intent(out)::hdferr
integer(8),intent(in),optional::size_hint
integer(8),intent(in),optional::lcpl_id
integer(8),intent(in),optional::gcpl_id
integer(8),intent(in),optional::gapl_id
end
...
character(*,1),intent(out)::obj_name
integer(4),intent(out)::obj_type
integer(4),intent(out)::hdferr
end
subroutine h5gn_members_f(loc_id,name,nmembers,hdferr)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::name
integer(4),intent(out)::nmembers
integer(4),intent(out)::hdferr
end
subroutine h5glink_f(loc_id,link_type,current_name,new_name,hdferr)
integer(8),intent(in)::loc_id
integer(4),intent(in)::link_type
character(*,1),intent(in)::current_name
character(*,1),intent(in)::new_name
integer(4),intent(out)::hdferr
end
subroutine h5glink2_f(cur_loc_id,cur_name,link_type,new_loc_id,new_name,hdferr)
integer(8),intent(in)::cur_loc_id
character(*,1),intent(in)::cur_name
integer(4),intent(in)::link_type
integer(8),intent(in)::new_loc_id
character(*,1),intent(in)::new_name
integer(4),intent(out)::hdferr
end
...
integer(8),intent(in)::dst_loc_id
character(*,1),intent(in)::dst_name
integer(4),intent(out)::hdferr
end
...
character(size,1),intent(out)::buffer
integer(4),intent(out)::hdferr
end
...
integer(8),intent(in)::grp_id
integer(8),intent(out)::gcpl_id
integer(4),intent(out)::hdferr
end
subroutine h5gget_info_f03(loc_id,ginfo,hdferr)
integer(8),intent(in)::loc_id
...
subroutine h5gget_info_f90(loc_id,storage_type,nlinks,max_corder,hdferr,mounted)
integer(8),intent(in)::loc_id
integer(4),intent(out)::storage_type
integer(4),intent(out)::nlinks
integer(4),intent(out)::max_corder
integer(4),intent(out)::hdferr
logical(4),intent(out),optional::mounted
end
subroutine h5gget_info_by_idx_f03(loc_id,group_name,idx_type,order,n,ginfo,hdferr,lapl_id)
integer(8),intent(in)::loc_id
...
subroutine h5gget_info_by_idx_f90(loc_id,group_name,idx_type,order,n,storage_type,nlinks,max_corder,hdferr,lapl_id,mounted)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::group_name
integer(4),intent(in)::idx_type
integer(4),intent(in)::order
...
subroutine h5gget_info_by_name_f03(loc_id,name,ginfo,hdferr,lapl_id)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::name
type(h5g_info_t),intent(out),target::ginfo
integer(4),intent(out)::hdferr
...
subroutine h5gget_info_by_name_f90(loc_id,name,storage_type,nlinks,max_corder,hdferr,lapl_id,mounted)
integer(8),intent(in)::loc_id
character(*,1),intent(in)::name
integer(4),intent(out)::storage_type
integer(4),intent(out)::nlinks
